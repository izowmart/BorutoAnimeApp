...
fun RatingWidget(
    ...
    val startPath = remember { PathParser().parsePathString(pathData = starPathString).toPath() }
    val startPathBounds = remember { startPath.getBounds() }
...
fun FilledStarPreview() {
    ...
    FilledStar(starPath = starPath, startPathBounds = starPathBounds, scaleFactor = 3f)
}
...
fun EmptyStarPreview() {
    ...
    EmptyStar(starPath = starPath, startPathBounds = starPathBounds, scaleFactor = 3f)
}